  ...
  <div class="mdui-container">
    ...
    <table style="width:100%">
      <tr>
        ...
        <td style="width:60%">
          <select v-model="expenseType" class="mdui-select" id="demo-js" style="width: 100%;">
      ...
      <tr>
        ...
        <td style="width:65%">
          <input v-model="fromDate" id="date" class="mdui-select" style="width: 100%;" type="date">
      ...
      <tr>
        ...
        <td style="width:65%">
          <input v-model="endDate" id="date" class="mdui-select" style="width: 100%;" type="date">
        </td>
      </tr>
      ...
      <tr>
        ...
        <td style="width:65%">
          <select v-model="currency" class="mdui-select" id="demo-js" style="width: 100%;">
            <option value="0">Japanese Yen (JPY)</option>
            <option value="1">Chinese Yuan Renminbi (CNY)</option>
      ...
      <tr>
        ...
        <td style="width:65%">
          <div class="mdui-textfield">
            <input v-model="account" class="mdui-textfield-input" type="number" placeholder="0">
          </div>
        </td>
      </tr>
    </table>
...
export default {
  data() {
    return {
      ...
      FilecodeList: [],
      isSubmit: false,
      expenseInfoVo: { username: "10000001", password: "1" },
      requestNo: "190501100501",
      requestType: "0",
      expenseType: "0",
      requesterId: "10000001",
      requestDate: "",
      fromDate: "",
      endDate: "",
      currency: "0",
  ...
  methods: {
    expense2() {
      this.$axios
        .post("/expense2", {
          username: this.expenseInfoVo.username,
          password: this.expenseInfoVo.password,
          ...
          attachReceipt: this.attachReceipt,
        })
